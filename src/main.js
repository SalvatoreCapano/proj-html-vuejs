...
import { faChevronDown, faArrowRight, faLocationDot } from '@fortawesome/free-solid-svg-icons'
import { faTwitter, faFacebookF, faInstagram, faLinkedin } from '@fortawesome/free-brands-svg-icons'

/* add icons to the library */
library.add(faChevronDown, faTwitter, faFacebookF, faInstagram, faLinkedin, faClock, faFileLines, faUser, faArrowRight, faCalendar, faEye, faLocationDot)
